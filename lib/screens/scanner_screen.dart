...
class _ScannerScreenState extends State<ScannerScreen>
  ...
  Future<void> _checkPermission() async {
    // Sadece durumu kontrol et, istek gönderme
    ...
    // İzin yoksa hiçbir şey yapma, UI zaten izin ekranını gösterecek
  }
  ...
  void _onDetect(BarcodeCapture capture) {
    ...
    // Haptic feedback - Check settings first
    final vibrateOnScan = context.read<SettingsProvider>().vibrateOnScan;
    if (vibrateOnScan) {
